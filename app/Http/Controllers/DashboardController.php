...
class DashboardController extends Controller
{
    ...
    public function dashboard($id) {
        ...
        ->select('devices.device_id','devices.customer_id','devices.usuario', 'devices.description', DB::raw('COUNT(components.component_id) as q_components'), DB::raw('SUM(components.amount) as s_components'), 'devices.created_at', 'devices.enabled')
