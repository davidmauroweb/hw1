            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="is_admin" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de Usuario') }}</label>

                            <div class="col-md-6">
                                <select id="is_admin" class="form-control @error('user_type') is-invalid @enderror" name="is_admin" value="{{ old('user_type') }}" required>
