...
<div class="modal fade" id="PasswordModal" tabindex="-1" role="dialog" aria-labelledby="PasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
       ...
       <hr>
       <input type="hidden" value="0" id = "id_user_password" name="user_password">
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button data-bs-toggle="modal" data-bs-target="#PasswordModal" id = 'btnPassword' class='btn btn-warning btn-sm' onclick="$('#id_user_password').val({{$user->user_id}}); $('#PasswordModalLabel').text('ACTUALIZAR CONTRASEÑA DE ' + {{$user->username}});"><i class="fas fa-key" aria-hidden="true" data-toggle="tooltip" data-placement="top" title='Establecer Contraseña de Accesso'></i></button></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
