      ...
      <div class="modal-content">
        ...
        <div class="row">
            <div class="col-sm-12 mx-auto">
                ...
                <div class="col-sm"><div class="d-flex justify-content-center"><a href="{{ route('hardware.dashboard', base64_encode($customer->customer_x))}}" class="btn btn-primary active" role="button" aria-pressed="true">{{$customer->business_name}}</a></div> </div>
                @endforeach
                </div>
                </div>  
                @endif
